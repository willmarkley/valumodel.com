...
def calc_enter_val(enterprise_value, assumptions, fcf, wacc, curr_year, projected_years):
	...
	for year in projected_years:
		fcf[('Discount Factor',year)]                        = 1/( (1+wacc['WACC'])**(year-curr_year) )
	...
	enterprise_value['Present Value of Terminal Value'] = enterprise_value['Terminal Value']*fcf[('Discount Factor',projected_years[4])]
